...
{
//    LL_ADC_REG_StartConversionSWStart(ADC1);
    // Waiting to convert complete (Flag EOC - End Of Conversion -> EOS - End Of Sequence)
    while (!LL_ADC_IsActiveFlag_EOCS(ADC1));

    // Return ADC result with 12 bits data
